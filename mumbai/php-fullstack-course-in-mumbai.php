...
<body class="body">
    ...
    <div class="container  mt-5 mb-3">
        <div class="row mx-3 mx-md-0 mt-5 mb-3 pt-4 rounded" style="box-shadow: rgba(0, 0, 0, 0.5) 0px 4px 24px;">
            <img src="./assets/img/roadmap-php-fullstack.png" alt="" class="img-fluid">
        </div>
    </div>
    <!-- roadmap-image end -->
                ...
                <div class="col-md-7" id="faqs">
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#php" aria-expanded="false" aria-controls="php">
                                    Php
                                    <span class="bg-success text-white rounded-pill fw-normal p-1 ms-2"
        ...
        <div class="container py-5 px-4 px-md-0">
            <div class="row">
                <div class="col-12 text-center my-3">
                    <h2 class="fw-bolder">Programming Languages & Tools Covered in Php Full Stack Developer Course
                    </h2>
                </div>
    ...
    <!-- footer section end -->
    <!-- fixed section start -->
    <a href="https://wa.link/93qjn8" class="btn-whatsapp">
