...
<body class="body">
    ...
    <div class="popup-screen">
        <div class="popup">
            <div class="d-flex justify-content-between">
                <h5 class="h4">Python Fullstack Enquiry</h5>
        ...
        <div class="container-lg">
            <div class="row py-5">
                <div class="col-lg-8 col-md-7 col-12 px-5 p-md-0 pb-5">
                    ...
                    <h1>Python Full Stack <br> Intensive Training Program</h1>
    ...
    <div class="container  mt-5 mb-3">
        <div class="row mx-3 mx-md-0 mt-5 mb-3 pt-4 rounded" style="box-shadow: rgba(0, 0, 0, 0.5) 0px 4px 24px;">
            <img src="./assets/img/roadmap-python-fullstack.png" alt="" class="img-fluid">
        </div>
    </div>
    <!-- roadmap-image end -->
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="fw-bold mb-4 text-white">Python Full Stack Developer Curriculum</h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-7" id="faqs">
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#python" aria-expanded="false" aria-controls="python">
                                    Python
                                    <span class="bg-success text-white rounded-pill fw-normal p-1 ms-2"
                            ...
                            <div id="python" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <ul>
    ...
    <!-- footer section end -->
    <!-- fixed section start -->
    <a href="https://wa.link/2s9zar" class="btn-whatsapp">
