...
<body class="body">
    ...
    <section id="why-python">
        <div class="container py-5">
            <div class="row">
                <h2 class="fw-bold mb-4 text-center">Web Development Courses in Mumbai - <span class="blue"> CNC WEB
                        WORLD</span></h2>
            </div>
            <div class="row ">
                <div class="col-lg-6 ">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center ">
                    <p>
                        If you're looking for the <b>Best Web Development Courses in Mumbai</b>, <b>CNC WEB WORLD</b>
                        offers industry-relevant training programs designed to help you master web technologies. Our
                        <b>Web Development Training in Mumbai</b> is tailored for beginners and professionals looking to
                        upgrade their skills in web technologies. With expert faculty, hands-on projects, and 100% job
                        placement assistance, our <b>web development classes in Mumbai</b> are your gateway to a
                        successful career in <b>web development</b>.
                    </p>
                    <h5 class="fw-bold blue">Placement Assistance & Career Support</h5>
                    <p>Our <b>Web Development Courses in Mumbai with placement </b>include career counseling, resume
                        building, mock interviews, and direct job referrals to top companies. We have partnerships with
                        leading IT firms to help you land your dream job.</p>
                </div>
            </div>
    ...
    <div class="course-content">
        <div class="container-lg px-4 px-lg-0 py-5">
            ...
            <ol>
                ...
                <li class="mb-2">
                    <b>Industry-Experienced Trainers : </b>
                    Our trainers are industry professionals with years of experience in web development and provide
                    real-world insights during training.
                </li>
                <li class="mb-2">
                    <b>Hands-on Practical Training : </b>
                    We believe in learning by doing! Our web development training in Mumbai includes live projects and
                    case studies to give you practical exposure.
                </li>
                <li class="mb-2">
                    <b>Placement Assistance : </b>
                    We offer web development courses in Mumbai with placement, ensuring our students get opportunities
                    in leading IT firms and startups.
                </li>
                <li class="mb-2">
                    <b>Flexible Learning Modes : </b>
                    We provide online and offline web development classes in Mumbai, allowing students to choose the
                    best learning mode that fits their schedule.
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="course-content">
        <div class="container-lg px-4 px-lg-0 py-5">
            <h4 class="fw-bold blue">Courses Offered </h4>
            <ol>
                <li class="mb-2">
                    <span class="fw-bold blue">Web Design Course in Mumbai : </span> If you want to start your journey
                    in
                    web design, our website design course in Mumbai covers UI/UX principles, responsive design, and
                    graphic tools like Photoshop and Figma.
                    <p class="fw-bold">Key Topics Covered:</p>
                    <ul>
                        <li> HTML5, CSS3, and JavaScript</li>
                        <li> Responsive Web Design</li>
                        <li> UI/UX Principles</li>
                        <li> Web Graphics and Prototyping</li>
                    </ul>
                </li>
                <li class="mb-2">
                    <span class="fw-bold blue"> Full-Stack Web Development Course in Mumbai : </span>
                    Become a full-stack web developer with expertise in front-end and back-end technologies. Our web
                    development courses in Mumbai provide complete knowledge of modern frameworks and databases.
                    <p class="fw-bold">Key Topics Covered:</p>
                    <ul>
                        <li>Front-end: HTML, CSS, JavaScript, Bootstrap, ReactJS</li>
                        <li> Back-end: Node.js, Express.js, PHP, Python (Django/Flask)</li>
                        <li>Databases: MySQL, MongoDB</li>
                        <li>APIs and Web Services</li>
                    </ul>
                </li>
                <li class="mb-2">
                    <span class="fw-bold blue"> MERN Stack Web Developer Course in Mumbai : </span>
                    The MERN stack (MongoDB, Express.js, React.js, and Node.js) is one of the most in-demand
                    technologies today. Enroll in our web developer course in Mumbai and learn to build powerful web
                    applications.
                    <p class="fw-bold">Key Topics Covered:</p>
                    <ul>
    ...
    <div class="course-content">
        <div class="container-lg px-4 px-lg-0 py-5">
            ...
            <ul>
                ...
                <li>Entrepreneurs and business owners wanting to create their own websites</li>
                <li>Anyone interested in learning website design and development</li>
            </ul>
        </div>
    </div>
    <!-- course-content end -->
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">What are the prerequisites for joining web development training in
                                Mumbai?</span>
                        </button>
                    </h2>
                    <div id="collapse1" class="accordion-collapse collapse show" data-bs-parent="#accordionExample2">
                        <div class="accordion-body">
                            <p>No prior programming knowledge is required. However, basic computer skills and an
                                interest in coding can be beneficial.</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">How long does the web development course in Mumbai take?</span>
                        </button>
                    </h2>
                    <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                        <div class="accordion-body">
                            <p>Our courses typically range from 3 to 6 months, depending on the specialization and
                                learning pace.</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">Do you offer a web design course in Mumbai separately?</span>
                        </button>
                    </h2>
                    <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                        <div class="accordion-body">
                            <p>Yes, we offer a dedicated website design course in Mumbai, focusing on UI/UX, graphic
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header ">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">Is there job placement support after completing the web
                                developer course in Mumbai?</span>
                        </button>
                    </h2>
                    <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                        <div class="accordion-body">
                            <p>Yes, CNC WEB WORLD provides web development courses in Mumbai with placement assistance,
                                helping students connect with top recruiters in the industry.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">What is the career scope after completing a web development
                                course?</span>
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <span class="fw-semibold">Do you offer online web development training?</span>
                        </button>
                    </h2>
