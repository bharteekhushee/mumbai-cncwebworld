...
<body class="body">
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="fw-bold mb-4 text-white">Frontend Developer Curriculum</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5 px-4 px-md-0">
            <div class="row">
                <div class="col-12 text-center my-3">
                    <h2 class="fw-bolder">Programming Languages & Tools Covered in Frontend Developer Course
                    </h2>
                </div>
            </div>
            <div class="row">
    ...
    <!-- footer section end -->
     <!-- fixed section start -->
     <a href="https://wa.link/3q4zgx" class="btn-whatsapp">
