...
<body class="body">
    ...
    <div class="container  mt-5 mb-3">
        <div class="row mx-3 mx-md-0 mt-5 mb-3 pt-4 rounded" style="box-shadow: rgba(0, 0, 0, 0.5) 0px 4px 24px;">
            <img src="./assets/img/roadmap-ui-ux.png" alt="" class="img-fluid">
        </div>
    </div>
    <!-- roadmap-image end -->
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="fw-bold mb-4 text-white">UI / UX Developer Curriculum</h2>
                </div>
            </div>
        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#uiux" aria-expanded="false" aria-controls="uiux">
                                    UI/UX Design
                                    <span class="bg-success text-white rounded-pill fw-normal p-1 ms-2"
                                        style="font-size: 12px;">#Frontend</span>
                                    <span class="ms-auto">
                            ...
                            <div id="uiux" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <ol>
                                                ...
                                                <li>UX Research & Analysis
                                                    <ul>
                                                        ...
                                                        <li>User Research Methods (Surveys, Interviews)</li>
                                                        <li>Competitor Analysis & Market Research</li>
                                                    </ul>
                                                </li>
                                                <li>Wireframing & Prototyping Tools
                                                    <ul>
                                                        <li>Figma</li>
                                                        <li>Adobe XD</li>
                                                    </ul>
                                                </li>
                                                <li>UX Writing & Microinteractions
                                                    <ul>
                                            ...
                                            <ol start="7">
                                                ...
                                                <li>User Interface (UI) Design
                                                    <ul>
                                                        ...
                                                        <li>Typography, Colors, and Layouts</li>
                                                        <li>Designing for Web & Mobile</li>
                                                    </ul>
                                                </li>
                                                <li>UI Development Basics
                                                    <ul>
                                                        <li>Introduction to HTML, CSS, and JavaScript for UI</li>
                                                        <li>Using UI Libraries (Bootstrap, Tailwind CSS)</li>
                                                    </ul>
                                                </li>
                                                <li>Design Systems & Accessibility
                                                    <ul>
                                                        <li>Creating & Maintaining Design Systems</li>
                                                        <li>Web Accessibility (WCAG Guidelines)</li>
                                                    </ul>
                                                </li>
                                                <li>UI/UX Tools & Software
                                                    <ul>
                                                        <li>Adobe Photoshop & Illustrator</li>
                                                        <li>InVision for Prototyping</li>
                                                    </ul>
                                                </li>
                                                <li> UI/UX Trends & Case Studies
                                                    <ul>
                                                        <li>Modern UI/UX Trends</li>
        ...
        <div class="container py-5 px-4 px-md-0">
            <div class="row">
                <div class="col-12 text-center my-3">
                    <h2 class="fw-bolder">Programming Languages & Tools Covered in UI/UX Training Course
                    </h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12 rounded-4 border py-3 px-4 bg-white shadow">
                    <div class="row text-center row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mx-auto">
                        ...
                        <div class="col">
                            <img src="./assets/img/figma.png" alt="" class="img-fluid">
                        </div>
                        <div class="col">
                            <img src="./assets/img/photoshop.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="col">
    ...
    <!-- footer section end -->
    <!-- fixed section start -->
    <a href="https://wa.link/zdpgww" class="btn-whatsapp">
