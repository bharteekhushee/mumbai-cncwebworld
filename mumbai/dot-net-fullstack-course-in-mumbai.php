...
<head>
    ...
    <title>.NET Full Stack Course in Mumbai | Best Full Stack .NET Training with Placement	</title>
   <meta name="description" content="Enroll in CNC Web World’s .NET Full Stack course in Mumbai to master ASP.NET, MVC, C#, and front-end technologies. Gain hands-on experience and 100% placement assistance.">
...
<body class="body">
                ...
                <div class="col-md-7" id="faqs">
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#cdotnet" aria-expanded="false" aria-controls="cdotnet">
                                    C# .Net
                                    <span class="bg-success text-white rounded-pill fw-normal p-1 ms-2"
                            ...
                            <div id="cdotnet" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <ul>
    ...
    <!-- footer section end -->
    <!-- fixed section start -->
    <a href="https://wa.link/6kbnp9" class="btn-whatsapp">
